...
## 2.&emsp;下载南向IDE
&emsp;2.1&emsp;打开[下载南向IDE链接](https://device.harmonyos.com/cn/ide#download)，点击下载，如图：

&emsp;&emsp;<img src="./figures/打开IDE下载链接.png" width = "1000"  alt="打开IDE下载链接" align=center /> 

&emsp;2.2&emsp;以下载linux版本为例，点击下载时候，会提示需要登录，输入刚才注册的账号和密码，点击：“授权并登录”，如图：
...
## 3.&emsp;注册
&emsp;3.1.&emsp;打开网址：https://gitee.com/ 点击注册，如图

&emsp;&emsp;<img src="./figures/点击注册.png" width = "700"  alt="点击注册" align=center /> 
...
&emsp;1.1&emsp;打开如下链接，可进入Gitee源码仓：
链接：
https://gitee.com/openharmony-sig/vendor_oh_fun/tree/master/bearpi-hm_nano-oh_flower

&emsp;1.2&emsp; 克隆/下载处，点击下载ZIP，如图：

&emsp;&emsp;<img src="./figures/下载代码.png" width = "1000"  alt="下载代码" align=center />


&emsp;1.3&emsp; 解压“openharmony-sig-vendor_oh_fun-master.zip”文件，进入“bearpi-hm_nano-oh_flower”文件夹，获得以下文件
...
&emsp;2.1&emsp; 通过TypeC数据线，把电脑与BearPi-HM Nano连接。
    
&emsp;2.2&emsp; 双击打开“02_USB驱动“文件夹下的”CH341SER.EXE“文件，并点击安装，驱动安装成功将如下图所示。

&emsp;&emsp;![](./figures/安装驱动.png)

&emsp;注：若提示“安装失败”，请点击“卸载”，再点击“安装”

&emsp;2.3&emsp;	打开电脑设备管理器，查看开发板的连接的端口，该端口用于后续烧录代码及打印调试日志使用。
...
&emsp;3.1&emsp;打开“04_烧录工具”文件下的“HiBurn.exe”工具，并点击Refresh，在COM中选择上一步看到的COM号。然后点击Setting，并选择 Com settings。
    
&emsp;&emsp;![](./figures/选择端口.png)

&emsp;3.2&emsp; 在Com settings中设置Baud为：921600（代表该串口的烧录速率），点击确定。

&emsp;&emsp;![](./figures/设置波特率.png)

&emsp;3.3&emsp;	点击 Hiburn工具中的Select file按钮，在弹出的文件框中，选择“03_固件”文件下的OpenHarmony_flower_V0.1 文件。

&emsp;&emsp;![](./figures/编译固件.png)

&emsp;3.4&emsp;	点击Auto burn复选框，然后点击Connect，此时Connect按钮变成Disconnect，等待下载。
 
&emsp;&emsp;![](./figures/连接开发板.png)

&emsp;3.5&emsp;	复位开发板RESET按键，开始下载程序。

&emsp;&emsp;![](./figures/复位开发板.png)

&emsp;&emsp;![](./figures/等待烧录.png)
    
&emsp;3.6&emsp;	直到出现Execution Successful字样，程序下载完成。
    
&emsp;&emsp;![](./figures/烧录成功.png)

&emsp;3.7&emsp;	下载完后，点击Disconnect按钮，否则再次按下复位键后会重新开始烧录代码。
...
&emsp;&emsp;1.1	打开IDE用户指南链接：[用户指南-Ubuntu开发环境准备 (harmonyos.com)](https://device.harmonyos.com/cn/docs/ide/user-guides/install_ubuntu-0000001072959308)，护花使者的代码是在Linux环境下编译的，所以我们要选择在Ubuntu下安装IDE工具，如图：
 ...
 &emsp;&emsp;&emsp;![](./figures/image077.png)
...
&emsp;&emsp;1.2	按照开发环境要求，我们需要Ubuntu 18以上的版本（虚拟机和Ubuntu自行安装）以及[相关的工具](https://device.harmonyos.com/cn/docs/ide/user-guides/install_ubuntu-0000001072959308)，根据获取渠道进行下载（注意：各软件版本要求），如图：
 ...
 &emsp;&emsp;&emsp;![](./figures/image079.png)

&emsp;&emsp;1.3	打开Ubuntu->终端，根据下图步骤将Ubuntu shell改为bash，如图：

 &emsp;&emsp;&emsp;![](./figures/image081.png)
...
&emsp;&emsp;1.4	之后根据[官方步骤](https://device.harmonyos.com/cn/docs/ide/user-guides/install_ubuntu-0000001072959308)依次安装python, Node.js, Hpm, Visual Studio Code和DevEco Device Tool即可，到此开发环境安装完毕，如图：
 ...
 &emsp;&emsp;&emsp;![](./figures/image083.png)
 
## 2.	安装编译工具链
&emsp;&emsp;2.1	选择Ubuntu平台安装编译工具链，如图：

&emsp;&emsp;&emsp;![](./figures/image085.png)

&emsp;&emsp;2.2	下载Hi3861系列的编译工具链，如图：
...
&emsp;&emsp;&emsp;![](./figures/image093.png)
