...
&emsp;&emsp;在小程序“我的”界面输入华为账号名、IAM账号名及密码。若没有华为账号名、IAM账号名及密码，请按照`“4.2.2. 获取华为账号名、4.2.3 获取IAM账号名及密码”`步骤进行。

&emsp;&emsp;<img src="./figures/登录账号.jpg" width = "300"  alt="登录账号" align=center />


&emsp;&emsp;4.2.2. **获取华为账号名**
...
&emsp;填写设备名称（自定义填写），以及设备连接目标WiFi的账号和密码（可开启自身手机热点充当wifi进行简单测试），当提示“请将NFC模块靠近设备”时，**将手机NFC感应区（不同手机的NFC感应部位不同）靠近开发板的NFC天线处，此时NFC灯会亮，显示配置成功即可。**
