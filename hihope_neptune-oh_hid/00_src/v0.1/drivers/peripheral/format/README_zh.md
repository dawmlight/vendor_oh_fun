...
Format驱动提供给framework层可直接调用的能力接口，主要功能有：创建、销毁复用器和解复用器对象，启停复用和解复用操作、获取片源属性、从片源读取数据帧处理、添加轨道和数据帧到复用器、事件回调等
...
<td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p1248524162220"><a name="p1248524162220"></a><a name="p1248524162220"></a>添加复用器轨道</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p114869411222"><a name="p114869411222"></a><a name="p114869411222"></a>写入轨道数据</p>
</td>
</tr>
...
-   提供Format HDI接口供framework层调用，实现片源解析和片源合成基本功能。
