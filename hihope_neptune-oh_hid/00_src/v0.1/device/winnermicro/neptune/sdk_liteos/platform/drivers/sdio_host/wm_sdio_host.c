...
int wm_sdh_config(void)
{
	...
	else
	{
		...
		{
			case 240: /*SDIO - 40MHz*/
				SDIO_HOST->MMC_CARDSEL = 0xF7; //enable module, enable mmcclk
				SDIO_HOST->MMC_CTL = 0xd3; //4bits, high speed,auto transfer, mmc mode.
				break;
			case 160: /*SDIO-40MHz*/
				SDIO_HOST->MMC_CARDSEL = 0xF7; //enable module, enable mmcclk
				SDIO_HOST->MMC_CTL = 0xcb; //4bits, high speed, auto transfer, mmc mode.
				break;
			case 80: /*SDIO-40MHz*/
				SDIO_HOST->MMC_CARDSEL = 0xF7; //enable module, enable mmcclk
				SDIO_HOST->MMC_CTL = 0xc3; //4bits, high speed, auto transfer, mmc mode.
				break;
			case 40: /*SDIO-20MHz*/
				SDIO_HOST->MMC_CARDSEL = 0xF7; //enable module, enable mmcclk
				SDIO_HOST->MMC_CTL = 0xc3; //4bits, high speed,  auto transfer, mmc mode.
