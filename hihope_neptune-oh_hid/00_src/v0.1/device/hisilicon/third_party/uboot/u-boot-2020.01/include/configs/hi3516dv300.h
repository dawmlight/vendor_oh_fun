...
/* CONFIG_AUTO_UPDATE the flag for auto update. 1:enable; 0:disable */
#ifndef CONFIG_MINI_BOOT
#define CONFIG_AUTO_UPDATE          1
#else
 /* The automatic upgrade function is disabled for the small-sized boot. */
...
#define CONFIG_OHOS_SEC_BOOT_SUPPORT
#ifdef  CONFIG_OHOS_SEC_BOOT_SUPPORT
/* CONFIG_OHOS_SEC_BOOT_ENABLE the flag for ohos sec boot. 1:enable; 0:disable */
#define CONFIG_OHOS_SEC_BOOT_ENABLE       0
#define CONFIG_OHOS_UBOOT_START_ADDR      0
#define CONFIG_OHOS_X509_BIN_START_ADDR   0xf0000
#endif
