...
typedef enum {
    IOT_GPIO_FLOATING, /**< floating status */
    IOT_GPIO_PULLHIGH, /**< pull high */
    IOT_GPIO_PULLLOW,  /**< pull low */
} IoTGpioIoPull;
 ...
 * The value <b>1</b> means to clean mask the interrupt function, and <b>0</b> means not to mask the interrupt function.
...
unsigned int IoTIoSetPull(unsigned int id, IoTGpioIoPull val);
