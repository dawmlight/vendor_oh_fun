...
/*******************************************************************************
**
** Function         GKI_ess_mem_init
**
** Description      This function is initialize memory to be used for gki_buffer
**
** Returns          void
**
*******************************************************************************/
void GKI_ess_mem_init(int HeapStart, int HeapEnd)
{
}

uint32_t GKI_time_get_os_boottime_ms(void)
{
    //return bdroid_sys_ticks;
    //tls_os_get_time(void);
...
void GKI_init(void)
{
    ...
    gki_buffer_init();
    gki_timers_init();
    //    gki_cb.com.OSTicks = GetTickCount();
